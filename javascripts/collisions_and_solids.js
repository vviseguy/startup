...
export class TimeParallelepiped extends TimeSolid {
  ...
  getIntersection(timeSolid) {
    switch (timeSolid.type){ // because they can only touch once, locating one intersection is good enough to return
      case "parallelepiped":
        /*if (bases touch && solids them pverlap or continue to touch ) get and return intersection // caution for cases of points touching
        for (vertical line){
          for (face in other solid){
            if (intersects) get and return intersection
          }
        }*/
        return null;
      case "cylinder":
